...
const STATS = {
  founded: 2001,      // Gründungsjahr
  years: 25,          // Jahre Erfahrung
  jobs: 14000,        // erledigte Einsätze
  team: 30,           // Mitarbeitende / Profis
  satisfaction: 98,   // % Kundenzufriedenheit
  recommend: 96,      // % Weiterempfehlung
  responseMin: 30,    // Ø Reaktionszeit / Anfahrt (Minuten)
  reviews: 320,       // Anzahl Bewertungen
