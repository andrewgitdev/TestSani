// Auto-kompiliert aus site/ui.jsx (kein Browser-Babel mehr).
// Quelle bleibt site/ui.jsx — bei Änderungen neu kompilieren.
(function () {
...
function Button({
  ...
  const inner = /*#__PURE__*/React.createElement(React.Fragment, null, icon && /*#__PURE__*/React.createElement(Icon, {
    name: icon,
    size: size === 'lg' ? 20 : 18
  }), /*#__PURE__*/React.createElement("span", null, children), iconRight && /*#__PURE__*/React.createElement(Icon, {
    name: iconRight,
    size: size === 'lg' ? 20 : 18
  }));
...
function SectionLabel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `inline-flex items-center gap-2.5 text-xs font-semibold uppercase tracking-[0.07em] ${light ? 'text-brand-glow' : 'text-brand'} ${className}`
  }, /*#__PURE__*/React.createElement("span", {
    className: `h-px w-6 ${light ? 'bg-white/40' : 'bg-copper'}`
  }), children);
}
...
function WaveDivider({
  ...
  const wave = (cls, fill, d) => /*#__PURE__*/React.createElement("path", {
    className: `wd-lyr ${cls}`,
    style: {
      fill
    },
    d: d
  ...
  }, wave('wd-l3', '#34495b', 'M0,52 C 240,34 480,34 720,50 C 960,66 1200,66 1440,50 C 1680,34 1920,34 2160,50 C 2400,66 2640,66 2880,50 L2880,90 L0,90 Z'), wave('wd-l2', '#4a6076', 'M0,46 C 288,66 432,66 720,44 C 1008,22 1152,22 1440,44 C 1728,66 1872,66 2160,44 C 2448,22 2592,22 2880,44 L2880,90 L0,90 Z'), wave('wd-l1', color, 'M0,40 C 240,20 480,20 720,38 C 960,56 1200,56 1440,40 C 1680,24 1920,24 2160,40 C 2400,56 2640,56 2880,40 L2880,90 L0,90 Z')));
}
...
function StarRating({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: i,
    className: i < value ? 'text-copper' : 'text-navy/20'
...
function StarFill({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M12 2.5l2.95 5.98 6.6.96-4.78 4.66 1.13 6.57L12 17.6l-5.9 3.1 1.13-6.57L2.45 9.44l6.6-.96L12 2.5z"
  }));
}
...
function Logo({
  ...
  return /*#__PURE__*/React.createElement("a", {
    ...
    className: "grid h-9 w-9 place-items-center rounded-md bg-brand"
    ...
    className: `font-sans font-bold leading-none ${dim} ${light ? 'text-white' : 'text-navy'}`
  }, "Rheinquell"));
}
...
function PageHeader({
  ...
  return /*#__PURE__*/React.createElement("section", {
    className: "bg-navy pt-24 pb-12 md:pt-32 md:pb-20"
    ...
    className: "mt-5 max-w-3xl font-sans text-3xl font-bold leading-[1.12] text-white md:text-5xl"
