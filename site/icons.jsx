...
function Icon({ name, size = 24, strokeWidth = 2, className = '', style = {}, sizeClass = '' }) {
  ...
  return <span ref={ref} className={'inline-flex items-center justify-center shrink-0 ' + sizeClass} style={sizeClass ? style : { width: size, height: size, ...style }} aria-hidden="true" />;
}
